...
const Index = () => {
  ...
  return (
    <>
        ...
        <div className="mx-auto container">
          <div className="flex flex-wrap justify-around">
            ...
            <div className="flex-col p-7 text-left  md:p-8 md:w-1/2 md:mx-auto md:my-10 ">
              <address className="mb-4 text-left text-sm from-neutral-400">SINCE 1993</address>
      ...
      <section id="featuredFilms" className="bg-black text-white sm:text-sm md:text-xl lg:text:2xl">
        <div className="flex-col bg-black">
          <div className="flex flex-col items-center md:flex-row justify-around pt-5 max-w-5xl mx-auto px-4">
            <div className="flex-1">
              <div className="title text-white pb-4 text-4xl from-neutral-400">Featured Films</div>
          ...
          <div className=" text-sm from-neutral-700 parent2 flex flex-wrap p-7 justify-between items-center w-6/12 mx-auto ">
            <a className=" hover:bg-red-500 hover:translate-y-0.5 p-1.5" href="#all">
              All
            </a>
            <a className=" hover:bg-red-500 hover:translate-y-0.5 p-1.5" href="#serialfilm">
              Serial Film
            </a>
            <a className=" hover:bg-red-500 hover:translate-y-0.5 p-1.5" href="#anthologyfilm">
              Anthology Film
            </a>
            <a className=" hover:bg-red-500 hover:translate-y-0.5 p-1.5" href="#shortfilm">
              Short Film
            </a>
          </div>
      ...
      <section id="work ">
        <div className="bg-red-600 text-white p-8 flex justify-center flex-col items-center">
          <h2 className="text-5xl from-neutral-900 p-8">Are You Ready? Let’s Work!</h2>
          <h4 className=" border-2 p-3 font-serif text-sm from-neutral-900 hover:translate-y-0.5 hover:bg-red-400 ">HIRE US NOW</h4>
        </div>
      </section>
      <section id="footer">
        <div className="footerr bg-white flex flex-col md:flex-row justify-around items-center  p-2">
          <div className="text-sm from-neutral-400">© Copyright 2022, Built by PRUTHVISH MODI</div>
          <div className="©rightlogo">
            <img className="p-4" src="https://res.cloudinary.com/pruthvish/image/upload/c_scale,h_60,w_165/v1648279748/you%20x%20potfolia%20image/th-removebg-preview_aooxmz.webp" alt="logo" />
          </div>
          <div className="icon">
            <nav className="flex flex-row items-center gap-4 h-28">
              <a className="hover:translate-y-0.5" href="https://www.facebook.com" target="_blank" rel="noreferrer">
              ...
              <a className="hover:translate-y-0.5" href="https://www.twitter.com" target="_blank" rel="noreferrer">
              ...
              <a className="hover:translate-y-0.5" href="https://www.gmail.com" target="_blank" rel="noreferrer">
                <svg width="22" height="18" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M3 1H19C20.1 1 21 1.9 21 3V15C21 16.1 20.1 17 19 17H3C1.9 17 1 16.1 1 15V3C1 1.9 1.9 1 3 1Z" stroke="#4E4B66" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M21 3.00098L11 10.001L1 3.00098" stroke="#4E4B66" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </a>
              <a className="hover:translate-y-0.5" href="https://www.intagram.com" target="_blank" rel="noreferrer">
                <svg width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect x="1" y="1" width="25" height="25" rx="7.13616" stroke="#14142B" strokeWidth="2" />
                  <circle cx="13.5009" cy="13.2655" r="5.09851" stroke="#14142B" strokeWidth="2" />
                  <circle cx="20.4792" cy="6.5788" r="1.58271" fill="#14142B" />
                </svg>
              </a>
              <a className="hover:translate-y-0.5" href="https://www.linkedin.com" target="_blank" rel="noreferrer">
                <svg width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect x="1" y="1" width="25" height="25" rx="7.13616" stroke="#14142B" strokeWidth="2" />
              ...
              <a className="hover:translate-y-0.5" href="https://www.whatsup.com" target="_blank" rel="noreferrer">
