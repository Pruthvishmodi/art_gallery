    ...
    <>
      ...
      <section id="work">
        <div className="bg-red-600 text-white p-8 flex justify-center flex-col items-center">
          ...
          <h2 className=" border-2 p-3 font-sans hover:bg-red-400 ">HIRE US NOW</h2>
        </div>
      </section>
      <section id="footer">
        <div className="footerr bg-white flex justify-around items-center p-2">
          <div>© Copyright 2020, Built by Themes Awesome</div>
          <div className="©rightlogo">
            <img src="https://res.cloudinary.com/pruthvish/image/upload/c_scale,h_60,w_165/v1648279748/you%20x%20potfolia%20image/th-removebg-preview_aooxmz.webp" alt="logo" />
          </div>
          <div className="icon">
